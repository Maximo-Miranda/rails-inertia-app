            ...
            <v-container>
                ...
                <v-row>
                    <v-col cols="12">
                        <v-card>
                            ...
                            <v-card-text>
                                <p>
                                    Este es un componente de Vuetify renderizado
                                    con Inertia.js
                                </p>
                        ...
                        >
                            <v-expansion-panel>
                                <v-expansion-panel-title
                                    data-testid="panel-1-title"
                                >
                                    Panel 1 - Información Personal
                                </v-expansion-panel-title>
                                <v-expansion-panel-text
                                    data-testid="panel-1-content"
                                >
                                    Contenido del panel 1: Aquí va la
                                    información personal.
                                </v-expansion-panel-text>
                            </v-expansion-panel>
                            <v-expansion-panel>
                                <v-expansion-panel-title
                                    data-testid="panel-2-title"
                                >
                                    Panel 2 - Preferencias
                                </v-expansion-panel-title>
                                <v-expansion-panel-text
                                    data-testid="panel-2-content"
                                >
                                    Contenido del panel 2: Aquí van las
                                    preferencias.
                                </v-expansion-panel-text>
                            </v-expansion-panel>
                        </v-expansion-panels>
                ...
                <v-row class="mt-4">
                    <v-col cols="12">
                        <v-tabs
                            v-model="activeTab"
                            data-testid="vuetify-test-tabs"
                        >
                            <v-tab value="tab1" data-testid="tab-1"
                                >Tab 1</v-tab
                            >
                            <v-tab value="tab2" data-testid="tab-2"
                                >Tab 2</v-tab
                            >
                            <v-tab value="tab3" data-testid="tab-3"
                                >Tab 3</v-tab
                            >
                        </v-tabs>
